...
const RELS_XML = () => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
const APP_XML = workbook => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
const CORE_XML = workbook => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
	<cp:coreProperties
...
const WORKBOOK_XML_RELS = workbook => strToU8(`<?xml version="1.0" encoding="UTF-8"?>
	<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
...
const SHEET_XML = sheet => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
	<worksheet
...
const SHAREDSTRINGS_XML = workbook => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
const STYLES_XML = () => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
const THEME_XML = () => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
const WORKBOOK_XML = workbook => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
const CONTENT_TYPES_XML = workbook => strToU8(`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
export const generate = (sheets) => {
	...
	return zipSync({
		...
		'xl': {
			...
			'styles.xml': STYLES_XML(workbook),
			'theme': {
				'theme1.xml': THEME_XML(workbook),
			},
			'worksheets': workbook.sheets.reduce((acc, sheet) => {
				acc[`sheet${sheet.id}.xml`] = SHEET_XML(sheet);
				return acc;
			}, {}),
